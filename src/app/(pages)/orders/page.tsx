...
export default function OrdersPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      // دمج الطلبات: الطلبات المحفوظة أولاً ثم التجريبية
      const allOrders = [...savedOrders, ...demoOrders];

      // ترتيب الطلبات حسب التاريخ (الأحدث أولاً)
      // نستخدم id كمعيار للترتيب للطلبات الجديدة
      allOrders.sort((a, b) => {
                        ...
                        <div className="mt-4 flex flex-col sm:flex-row gap-2">
                          ...
                          {order.status === "في الطريق" && (
                            <button
                              ...
                              onClick={() =>
                                showNotification("تتبع الطلب قريباً!", "info")
                              }
                            >
                              تتبع الطلب
                            </button>
