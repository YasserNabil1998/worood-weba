            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {categories.map((c) => (
                <Link
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    document.getElementById(c.sectionId)?.scrollIntoView({
                      behavior: "smooth",
                      block: "start",
                    });
                  }}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              className={`relative h-64 md:h-80 overflow-hidden shadow-lg transition-all duration-300 ${
                showWeddingBouquets ? "rounded-t-2xl" : "rounded-2xl"
              }`}
            >
              <Image
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-end">
                ...
                <button
                  onClick={() => setShowWeddingBouquets(!showWeddingBouquets)}
