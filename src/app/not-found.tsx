        ...
        <div className="max-w-4xl w-full text-center">
          ...
          <div className="mb-12 space-y-4">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
              ...
              <br />
              لكن لا تقلق، لدينا الكثير من الباقات الجميلة في انتظارك!
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            ...
            >
              <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-lg font-semibold text-[#2C3E2B]">الصفحة الرئيسية</span>
              </div>
            </Link>
            ...
            >
              <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-lg font-semibold text-[#2C3E2B]">تصفح الباقات</span>
              </div>
            </Link>
            ...
            >
              <div className="flex flex-col items-center gap-3">
                ...
                <span className="text-lg font-semibold text-[#2C3E2B]">المفضلة</span>
              </div>
            </Link>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#8B9D83] to-[#6B8E5F] rounded-2xl p-8 text-white">
            <h3 className="text-2xl font-bold mb-3">هل تحتاج إلى مساعدة؟</h3>
            <p className="mb-6 text-white/90">
              فريقنا جاهز لمساعدتك في اختيار الباقة المثالية لمناسبتك
            </p>
            <Link
              href="/contact"
