    ...
    <div>
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {/* عنوان التسليم */}
          <div className="flex items-center justify-between gap-3 p-3 bg-gradient-to-br from-blue-50 to-white rounded-xl border border-blue-100" dir="rtl">
            <div className="bg-blue-100 p-2 rounded-lg flex-shrink-0">
              <MapPin className="w-4 h-4 text-blue-600" />
            </div>
            <span className="text-sm text-gray-700 leading-relaxed flex-1" style={almaraiFont}>
