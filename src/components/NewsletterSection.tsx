...
const NewsletterSection = () => {
    ...
    return (
        <section className="py-12">
            <div className="max-w-5xl min-w-[80vw] mx-auto px-4 sm:px-6 lg:px-8 bg-[#FFF1F2] rounded-xl">
                <div className="relative overflow-hidden rounded-xl  py-6 px-4 sm:px-8 text-center">
                    ...
                    <p
                        ...
                        style={{ fontFamily: "var(--font-almarai)" }}
                    >
                        احصل على آخر العروض والتخفيضات مباشرة إلى بريدك
                        الإلكتروني
                    </p>
                    ...
                    <div className="mt-4 h-1 rounded bg-white/50 overflow-hidden">
                        <div
                            ...
                            style={{
                                width: `${
                                    isLoading ? progress : isSuccess ? 100 : 0
                                }%`,
                            }}
                        />
                    </div>
