...
import { SocialMediaLinksProps } from "@/types/contact";

// WhatsApp SVG Icon Component
const WhatsAppIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-[25px] h-[25px]">
        ...
        {data.links.map((link) => {
          ...
          return (
            <a
              ...
              className="text-gray-700 hover:text-[#5A5E4D] transition-colors duration-300"
              title={link.title}
            >
              <IconComponent />
            </a>
