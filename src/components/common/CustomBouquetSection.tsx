...
const CustomBouquetSection = ({
  ...
  return (
    <section className="py-6 sm:py-8 md:py-10 relative overflow-visible bg-background">
      <div className="w-full flex justify-center px-4 sm:px-6">
        ...
        <div className="w-[95%] max-w-[1440px] relative">
          ...
          >
            ...
            <AOSWrapper animation="fade-right" delay={0} duration={800}>
            ...
            <div className="absolute right-0 top-0 bottom-0 flex items-center justify-end w-full lg:w-auto z-10">
              <AOSWrapper animation="fade-left" delay={100} duration={800} className="w-full">
                <div className="w-full px-3 sm:px-4 md:px-8 lg:px-16 xl:pr-24 pl-[155px] sm:pl-[225px] md:pl-[305px] lg:pl-[385px] xl:pl-[455px] 2xl:pl-0">
                  <div className="text-right flex flex-col items-start justify-center h-full py-3 sm:py-4 md:py-6 lg:py-8 xl:py-0">
                    ...
                    <AOSWrapper animation="fade-left" delay={150} duration={600} className="w-full">
                      <div
                    ...
                    <AOSWrapper animation="fade-left" delay={200} duration={600} className="w-full">
                    ...
                    <AOSWrapper animation="fade-left" delay={250} duration={600}>
                      <Link
                        href={buttonHref}
