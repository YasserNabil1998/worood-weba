  ...
  const flowers = useMemo(() => {
    ...
    const generateFlowers = (side: "left" | "right"): Flower[] => {
      ...
      for (let i = flowerImagesShuffled.length - 1; i > 0; i--) {
        ...
        [flowerImagesShuffled[i], flowerImagesShuffled[j]] = [flowerImagesShuffled[j], flowerImagesShuffled[i]];
      }
      ...
      for (let i = 0; i < sideCount; i++) {
        ...
        const flowerImage = flowerImagesShuffled[i] || FLOWER_IMAGES[Math.floor(Math.random() * FLOWER_IMAGES.length)];
        ...
        return (
          ...
          >
            <Image
              ...
              style={{
                filter: "drop-shadow(0 4px 8px rgba(0, 0, 0, 0.12)) drop-shadow(0 0 12px rgba(139, 69, 19, 0.15))",
