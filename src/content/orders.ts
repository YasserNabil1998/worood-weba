...
export const defaultOrders: Order[] = [
    ...
    items: [
      {
        ...
        image: "/assets/ready-packages-page1/باقة الورد الأصفر الفاخر.png",
        price: 250,
        quantity: 1,
      ...
      },
      {
        id: "item-2",
        name: "ورود إضافية",
        image: "/assets/ready-packages-page1/باقة الخوخ الزهري.png",
        price: 100,
        quantity: 1,
      },
    ],
    ...
    items: [
      {
        ...
        image: "/assets/ready-packages-page1/باقة الورد الأبيض.png",
        price: 480,
        quantity: 1,
    ...
    items: [
      {
        ...
        image: "/assets/ready-packages-page1/باقة البنفسج الراقية.png",
        price: 220,
        quantity: 1,
        bouquetType: "باقة مختلطة",
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        id: "item-6",
        name: "باقة الورود الفاخرة",
        image: "/assets/ready-packages-page1/باقة الورد الأبيض.png",
        price: 450,
        quantity: 1,
        bouquetType: "باقة فاخرة",
      },
      {
        id: "item-7",
        name: "صندوق هدايا",
    ...
    deliveryAddress: "مكة المكرمة، حي الزاهر، شارع العزيزية",
    phoneNumber: "0505678901",
    paymentMethod: "فيزا",
    trackingNumber: "TRK-123456789",
    notes: "طلب خاص لمناسبة الزفاف",
  },
  {
    id: "6",
    ...
    items: [
      {
        id: "item-8",
        name: "باقة الورود الوردية",
        image: "/assets/ready-packages-page1/باقة البنفسج الراقية.png",
        price: 300,
        quantity: 1,
        bouquetType: "باقة وردية",
      },
    ],
