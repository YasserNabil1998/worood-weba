...
const occasionsData: Record<string, OccasionData> = {
    ...
    graduation: {
        ...
        category: "graduation",
        description:
            "احتفل بإنجازات أحبائك مع مجموعة مميزة من الهدايا المخصصة للتخرج. باقات الورود الفاخرة والهدايا الأنيقة التي تعبر عن فخرك وسعادتك بهذا الإنجاز العظيم. كل هدية مصممة لتكون ذكرى جميلة تدوم للأبد، وتحمل رسالة تقدير واعتزاز بالنجاح والتفوق.",
        productsCount: 156,
    ...
    "get-well": {
        ...
        category: "get-well",
        description:
            "أرسل أطيب التمنيات بالشفاء العاجل مع باقاتنا الجميلة والهدايا المريحة. مجموعة مختارة بعناية لتبعث الأمل والسعادة في قلوب المرضى، وترسم البسمة على وجوههم. كل هدية تحمل رسالة حب ودعم لتكون سبباً في تحسين معنوياتهم ورفع روحهم المعنوية.",
        productsCount: 89,
    ...
    congratulations: {
        ...
        description:
            "احتفل بالإنجازات والمناسبات السعيدة مع مجموعتنا الرائعة من الهدايا والبالونات الاحتفالية. سواء كان ترقية في العمل، نجاح جديد، أو أي مناسبة سعيدة، لدينا الهدية المثالية التي تعبر عن فرحتك ومشاركتك في هذه اللحظات الجميلة.",
        productsCount: 198,
    ...
    birthday: {
        ...
        category: "birthday",
        description:
            "احتفل بعيد ميلاد أحبائك مع تشكيلة رائعة من الهدايا والباقات المصممة خصيصاً لهذه المناسبة الخاصة. من الورود الجميلة إلى التورتات الشهية والبالونات المبهجة، كل هدية تحمل رسالة حب وتقدير لتجعل يوم ميلادهم لا يُنسى.",
        productsCount: 267,
        image: "/images/OccasionsSlider/OccasionsSlider-6.png",
        subcategories: [
