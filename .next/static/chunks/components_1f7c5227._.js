...
function AddToCartButton(param) {
    let { productId, productName, productPrice, productImage } = param;
    _s();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        children: isAdding ? 'جاري الإضافة...' : 'أضف إلى السلة'
    }, void 0, false, {
...
_s(AddToCartButton, "b6bafALiyA4tNhoTpSrs4s6fpRs=");
_c = AddToCartButton;
var _c;
...
function FavoriteButton(param) {
    ...
    const handleToggleFavorite = ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            try {
                ...
                notification.className = "fixed top-4 right-4 px-4 py-2 rounded-lg z-50 ".concat(isFavorited ? 'bg-gray-500' : 'bg-red-500', " text-white");
                notification.style.fontFamily = 'var(--font-almarai)';
                document.body.appendChild(notification);
                setTimeout(()=>notification.remove(), 3000);
            } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        className: "px-6 py-4 border rounded-lg font-semibold transition-colors ".concat(isFavorited ? 'bg-red-500 text-white border-red-500' : 'border-[#5A5E4D] text-[#5A5E4D] hover:bg-[#5A5E4D] hover:text-white'),
        style: {
            fontFamily: 'var(--font-almarai)'
        },
        children: isFavorited ? 'في المفضلة' : 'المفضلة'
    }, void 0, false, {
...
_s(FavoriteButton, "wVxhE3FgoGHyLD4dBVOCk3Gr2S4=");
_c = FavoriteButton;
var _c;
...
function QuantitySelector(param) {
    let { initialQuantity = 1, onQuantityChange } = param;
    _s();
    ...
    const handleDecrease = ()=>{
        if (quantity > 1) {
            ...
            onQuantityChange === null || onQuantityChange === void 0 ? void 0 : onQuantityChange(newQuantity);
        }
    };
...
_s(QuantitySelector, "K7P2Uhrq38nW+bnbDTU+K8aa9Nc=");
_c = QuantitySelector;
var _c;
...
//# sourceMappingURL=components_1f7c5227._.js.map