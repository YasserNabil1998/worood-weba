...
;
;
function AddToCartButton({ productId, productName, productPrice, productImage }) {
...
function FavoriteButton({ productId }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        className: `px-6 py-4 border rounded-lg font-semibold transition-colors ${isFavorited ? 'bg-red-500 text-white border-red-500' : 'border-[#5A5E4D] text-[#5A5E4D] hover:bg-[#5A5E4D] hover:text-white'}`,
        style: {
            fontFamily: 'var(--font-almarai)'
        },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9434931._.js.map