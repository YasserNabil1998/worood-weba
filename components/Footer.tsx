    ...
    <footer className="text-white" style={{backgroundColor:'#0F2433'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          {/* About Us */}
          <div>
            <h3 className="text-base md:text-lg font-semibold mb-3" style={{fontFamily:'var(--font-almarai)'}}>زهور الشمس</h3>
            <p className="text-gray-300 leading-relaxed text-sm" style={{fontFamily:'var(--font-almarai)'}}>
              أجمل الباقات لأجمل المناسبات. تقدم خدمات تنسيق الزهور لجميع المناسبات بأعلى جودة وأفضل الأسعار.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-base md:text-lg font-semibold mb-3" style={{fontFamily:'var(--font-almarai)'}}>روابط سريعة</h3>
          ...
          {/* Contact Us */}
          <div>
            <h3 className="text-base md:text-lg font-semibold mb-3" style={{fontFamily:'var(--font-almarai)'}}>تواصل معنا</h3>
            <div className="flex items-center gap-4 mb-3">
              ...
              <a href="#" aria-label="WhatsApp" className="text-gray-300 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-4 pt-6 border-t border-white/10">
          <div className="text-center">
            <p className="text-gray-300 text-xs md:text-sm" style={{fontFamily:'var(--font-almarai)'}}>
