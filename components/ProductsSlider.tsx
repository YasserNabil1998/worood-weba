    ...
    <section className="py-12 bg-white">
      <div className="w-full px-8 sm:px-12 lg:px-16 xl:px-24 2xl:px-32">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800" style={{ fontFamily: 'var(--font-almarai)' }}>
            سعادة في مزهرية
          </h2>
          <Link
            href="/bouquets"
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden px-12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.slice(currentIndex, currentIndex + 4).concat(
                  ...
                  <div className="bg-[#F5F3ED] rounded-3xl overflow-hidden hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="p-4 text-right">
                      <div className="flex items-center justify-end gap-1.5 mb-2">
                        ...
                        <span className="text-xl font-bold text-gray-800" style={{ fontFamily: 'var(--font-almarai)' }}>
                          {product.price}
                        </span>
                      </div>
                      <h3 className="text-sm font-medium text-gray-700 text-right" style={{ fontFamily: 'var(--font-almarai)' }}>
                        {product.title}
                      </h3>
                    </div>
                  </div>
